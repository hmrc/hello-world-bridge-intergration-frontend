...
class RatepayerPropertyLinkResponseSpec extends AnyWordSpec with Matchers {

  "RatepayerPropertyLinksResponse" should {
    "serialise and deserialise correctly with nested structures" in {
      ...
      json.as[RatepayerPropertyLinksResponse] shouldBe response
    }
  }
}
