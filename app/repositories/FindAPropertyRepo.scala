...
@Singleton
case class FindAPropertyRepo @Inject()(
  ...
  def upsert(userId: String, vmvProperties: VMVProperties): Future[Boolean] = {
    val document = StoredVMVProperties(userId, vmvProperties)
