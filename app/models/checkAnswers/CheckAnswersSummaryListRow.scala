...
final case class CheckAnswersSummaryListRow(
...
object CheckAnswersSummaryListRow {
  def summarise(checkYourAnswerRow: CheckAnswersSummaryListRow)(implicit messages: Messages): SummaryListRow = {
